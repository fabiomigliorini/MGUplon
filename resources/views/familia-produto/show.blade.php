...
@section('inscript')
    ...
    @include('layouts.includes.datatable.js', ['id' => 'datatable', 'url' => url('grupo-produto/datatable'), 'order' => 3, 'order_dir' => 'ASC', 'filtros' => ['codfamiliaproduto', 'codgrupoproduto' => 'codgrupoproduto', 'grupoproduto', 'inativo'] ])
@endsection
@stop