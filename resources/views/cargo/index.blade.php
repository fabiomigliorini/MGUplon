            ...
            {!! Form::model($filtro, ['id' => 'form-search', 'autocomplete' => 'on'])!!}
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::number('codcargo', null, ['class'=> 'form-control', 'id'=>'codcargo', 'step'=>1, 'min'=>1]) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
...
<div class='card'>
    <div class='card-block table-responsive'>
        @include('layouts.includes.datatable.html', ['id' => 'datatable', 'colunas' => ['URL', 'Inativo Desde', '#', 'Cargo', ]])
        <div class='clearfix'></div>
    </div>
</div>
...
@section('buttons')
    ...
    <a class="btn btn-secondary btn-sm" href="{{ url("cargo/create") }}"><i class="fa fa-plus"></i></a> 
