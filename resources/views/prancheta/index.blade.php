            ...
            {!! Form::model($filtro['filtros'], ['id' => 'form-search', 'autocomplete' => 'on'])!!}
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="codprancheta" class="control-label">#</label>
                        {!! Form::number('codprancheta', null, ['class'=> 'form-control', 'id'=>'codprancheta', 'step'=>1, 'min'=>1]) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="prancheta" class="control-label">Prancheta</label>
                        {!! Form::text('prancheta', null, ['class'=> 'form-control', 'id'=>'prancheta']) !!}
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
...
<div class='card'>
    <div class='card-block table-responsive'>
        @include('layouts.includes.datatable.html', ['id' => 'datatable', 'colunas' => ['URL', 'Inativo Desde', '#', 'Prancheta', 'Observacoes', ]])
        <div class='clearfix'></div>
    </div>
</div>
...
@section('buttons')
    ...
    <a class="btn btn-secondary btn-sm" href="{{ url("prancheta/create") }}"><i class="fa fa-plus"></i></a> 
