    ...
    <div class='col-md-6'>
        <div class='row'>
            ...
            <div class="col-md-12">
                ...
                <button  style="margin: 0 0 15px 0;" type="button" onclick="adicionaemitente();" class="btn btn-success"><i class="fa fa-plus-circle    "></i> Adicionar Emitente</button>
            </div>
...
<script src="{{ URL::asset('public/assets/plugins/maskedinput/jquery.maskedinput.min.js') }}"></script>
        ...
        if(cmc7.length==34){
            $.ajax({
                ...
                success: function(retorno) {
                    ...
                    if(retorno.valido){
                        $("#warning_cmc7").html("<span class='label label-success'><i class='fa fa-ok'></i> CMC7 Válido</span>");
                        ...
                        $('#cmc7').val('');
                        $('#cmc7').focus();
                        $("#warning_cmc7").html("<span class='label label-danger'><i class='fa fa-remove'></i> "+retorno.error+"</span>");
                    }
                },
...
function CarregaCampos(codchequeemitente,cnpj,emitente){
    ...
    html = html +  '</div>';
    html = html +  '<div class="form-group col-md-1"><label>&nbsp;&HorizontalLine;&nbsp;</label><a class="btn btn-danger row" id="remover"><i class="fa fa-trash"></i></a></div>';
    html = html +  '</div>';
