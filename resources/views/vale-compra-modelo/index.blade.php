...
@section('inscript')
    ...
    @include('layouts.includes.datatable.js', ['id' => 'datatable', 'url' => url('vale-compra-modelo/datatable'), 'order' => 6, 'order_dir' => 'DESC', 'filtros' => ['codvalecompramodelo'=>'codvalecompramodelo', 'inativo', 'modelo', 'codpessoafavorecido', 'ano' ] ])
