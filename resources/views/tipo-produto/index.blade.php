...
@section('inscript')
    ...
    @include('layouts.includes.datatable.js', ['id' => 'datatable', 'url' => url('tipo-produto/datatable'), 'order' => 3, 'order_dir' => 'ASC', 'filtros' => ['codtipoproduto'=>'codtipoproduto', 'tipoproduto', 'inativo'] ])
